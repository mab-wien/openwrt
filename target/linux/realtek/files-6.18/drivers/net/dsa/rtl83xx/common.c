...
int rtl83xx_packet_cntr_alloc(struct rtl838x_switch_priv *priv)
{
	 ...
	 * one LOG counter per PIE rule and does not pass through this allocator.
	 * Keep that range reserved so a route counter handed out here cannot
	 * alias a flow's LOG entry.
	 */
